...
import ru.unbread.configuration.RabbitConfiguration;
import ru.unbread.service.UpdateProducer;
import ru.unbread.utils.MessageUtils;
...
public class UpdateProcessor {
    ...
    public void processUpdate(Update update) {
        if (update == null) {
            log.error("Received update in null");
            return;
        }
