...
public class MainServiceImpl implements MainService {
    ...
    public MainServiceImpl(RawDataDAO rawDataDAO, ProducerService producerService, AppUserDAO appUserDAO, GroupDAO groupDAO, MemberDAO memberDAO, ZoneDAO zoneDAO) {
    ...
    private String processServiceCommand(AppUser appUser, String text, Update update) {
        ...
        return switch (serviceCommand) {
            ...
            case CREATE_GROUP -> processCreateGroupCommand(update);
            /*case CREATE_GROUP -> {
                appUser.setState(CREATE_GROUP_STATE);
                yield getAddMembersText();
            }*/
